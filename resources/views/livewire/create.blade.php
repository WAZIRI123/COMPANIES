                ...
                <form class="row g-3" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="inputState" class="form-select" name="category" wire:model="category">
                            ...
                            <option value=" Lodge Unclassified - Outside Attraction Area
"> Lodge Unclassified - Outside Attraction Area
                            </option>
            ...
            <div class="modal-footer">
                ...
                <input type="submit" class="btn btn-primary" wire:click.prevent="submit()"></input>
            </div>
        </div>
    </div>
</div>